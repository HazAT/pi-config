...
Every slide shows a small, low-contrast Sentry glyph in the top-left corner. Use the exact path from `${PI_SKILL_ROOT}/references/sentry-glyph.svg`.
...
- **Full wordmark**: `${PI_SKILL_ROOT}/references/sentry-logo.svg` — the "Sentry" logotype with glyph. Use on title slides.
- **Glyph only**: `${PI_SKILL_ROOT}/references/sentry-glyph.svg` — the standalone glyph mark. Use for compact branding.
