...
Every slide shows a small, low-contrast Sentry glyph in the top-left corner. Use the exact path from `skills/presentation-creator/references/sentry-glyph.svg`.
...
- **Full wordmark**: `skills/presentation-creator/references/sentry-logo.svg` — the "Sentry" logotype with glyph. Use on title slides.
- **Glyph only**: `skills/presentation-creator/references/sentry-glyph.svg` — the standalone glyph mark. Use for compact branding.
