...
|---------------|-------------------|
| `.py`         | `skills/skill-creator/references/python.md` |
| `.js`, `.ts`  | `skills/skill-creator/references/javascript.md` |
```
...
Similarly, don't repeat conventions already documented in `AGENTS.md`, `README.md`, or similar project instruction files. Reference them instead: "Follow the commit conventions in AGENTS.md" rather than copying the entire format spec.
...
- Revenue data: `grep -i "revenue" skills/skill-creator/references/finance.md`
- Pipeline data: `grep -i "pipeline" skills/skill-creator/references/sales.md`
```
