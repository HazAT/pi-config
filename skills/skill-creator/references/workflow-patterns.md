...
|-----------|-------------------|
| Creating documents | `skills/skill-creator/references/creation.md` |
| Editing documents | `skills/skill-creator/references/editing.md` |
```
...
2. Validate immediately: `uv run skills/skill-creator/scripts/validate.py`
...
2. Validate the plan: `uv run skills/skill-creator/scripts/validate_plan.py changes.json`
3. If validation fails, revise the plan and re-validate
4. Execute the plan: `uv run skills/skill-creator/scripts/apply_changes.py changes.json`
5. Verify the result
```
